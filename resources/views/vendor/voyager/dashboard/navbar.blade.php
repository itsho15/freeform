    ...
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav @if (config('voyager.multilingual.rtl')) navbar-left @else navbar-right @endif">
            ...
            <li class="dropdown lang">
                ...
                <ul class="dropdown-menu dropdown-menu-animated {{ ('ar' == session('lang')) ? "pull-right" : "" }}">

                    @foreach(config('voyager.multilingual.locales') as $lang)
                        <li class="{{ ($lang == session('lang')) ? " active" : "" }}">
                            <a href="{{ url('lang/'.$lang) }}"><i class="fa fa-flag"></i> {{$lang}} </a>
                        </li>
                    @endforeach
                </ul>
            </li>
